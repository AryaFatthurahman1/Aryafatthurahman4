...
if(isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if($user_id != $_SESSION['user_id']) {
        ...
        $error = 'Tidak dapat menghapus akun admin atau diri sendiri!';
    }
}
            ...
            <div class="col-md-10 content-wrapper">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 text-end">
                        <span class="text-muted">Total: <?php echo count($users); ?> pengguna</span>
                    </div>
                </div>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <a href="users.php?delete=<?php echo $user['id']; ?>" 
                                                   ...
                                                   onclick="return confirmDelete('Apakah Anda yakin ingin menghapus pengguna ini?')">
